...
- (NSArray*)definitions
{
    if(!_definitions)
    {
      ...
      @[@"Your current level. You get to higher levels by making the car travel certain distances. For example, you only have to travel 95 miles to unlock level 3!",
        ...
        @"The distance in miles that your car travelled. The number of miles is determined by how much biodiesel is in each gallon, and how many gallons that were bought with $50."];
        
        NSArray *secondSection = @[@"The amount of biodiesel produced per gallon of fuel.",
        ...
        NSArray *thirdSection = @[@"The methanol input. It costs money, so be mindful of how much you put in.",
                                  ...
                                  @"The oil that you put in your fuel. This determines the cost of the fuel, and also heavily dertermines how much biodiesel is produced in the simulation. More oil almost always means that the car can travel farther, so the oil is locked away at set levels to avoid making the game too easy!"];
